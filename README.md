  ...
  <tr>
    ...
    <td style="vertical-align: top; width: 70%;">
      <div style="text-align: center;">
        ...
        <p style="font-size: 8px;"><strong>Figure:</strong> Dendrogram of the Ward-linkage hierarchical clustering of the 51 scripts. Color chart: red: medoid, blue: isolated script.</p>
      </div>
    </td>
    <!-- Right Column -->
    <td style="vertical-align: top; width: 30%;">
      <div style="margin-bottom: 10px; text-align: center;">
        ...
        <p style="font-size: 8px;"><strong>Figure:</strong> Two-dimensional scaling of the Latin and Old Italic scripts which are close scripts with a SNN-distance of 0.26.</p>
      </div>
      <div style="text-align: center;">
        <img src="images/MDS_scripts.png" alt="MDS-scripts" style="width: 100%;"/>
        <p style="font-size: 8px;"><strong>Figure:</strong> Two-dimensional scaling of the 51 scripts. Marker chart: clusters. Color chart: red: medoid, blue: isolated script.</p>
      </div>
    </td>
  </tr>
</table>
